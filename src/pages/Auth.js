  ...
  const iniciarSesion = async (event) => {
    ...
    try {
      if (!emailValue || !passwordValue) {
        enqueueSnackbar('El correo electrónico y la contraseña de usuario son obligatorios.', {
          variant: 'error',
          persist: false,
          allowDownload: true,
        })
      ...
      await axiosInstance.post('seguridad/login/', {
        username: emailValue,
    ...
    <StyledWrapper>
      ...
      <div className="form">
        ...
        <div className="inputForm">
          ...
          <input placeholder="Correo electrónico" value={emailValue} onChange={handleEmailChange} className="input" type="text" />
        </div> <br></br>
        ...
        <div className="inputForm">
          ...
          <input placeholder="Enter your Password" value={passwordValue} onChange={handlePasswordChange} className="input" type="password" />
        </div>

        <div className="flex-row">
          <span className="span">Olvidó su contraseña?</span>
        </div>

        <SnackbarProvider />
        <button className="button-submit" onClick={iniciarSesion}>Iniciar sesión</button>

        <p className="p">¿No tiene una cuenta creada? <span className="span">Registrate</span></p>
        <p className="p line">Registrarse con:</p>
